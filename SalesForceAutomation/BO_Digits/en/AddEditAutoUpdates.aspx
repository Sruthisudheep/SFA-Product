                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                        ...
                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                ...
                                <div class="col-lg-3 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddlroute" RenderMode="Lightweight" Filter="Contains" runat="server" Width="100%"   DefaultMessage="Please Select" OnSelectedIndexChanged="ddlroute_SelectedIndexChanged" AutoPostBack="true" Skin="Silk">
                                            <Items>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="kt-portlet">
                                        ...
                                        <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                            <div class="col-lg-10">
                                                <h3 class="kt-portlet__head-title">UnAssigned Routes
                                                </h3>
                                            </div>

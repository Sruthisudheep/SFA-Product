...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class AddEditCusRoute : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    else                                                                        //If we are editing there will be a value and the following code will be executed.
                    {
                        ...
                        if (lstDatas.Rows.Count > 0)
                        {
                            ...
                            RecentSales, RecentOrder , MinOrderValue,ARRemark,GRSettings,BRSettings;
        ...
        public void SaveData()
        {
            ...
            ARRemarks,GRSettings,BrSettings;
            ...
            if (ResponseID.Equals("0") || ResponseID == 0)
            {
                ...
                string[] arr = {   cus,cusType,TCL , CDays,PT,
                    ...
                    ActManageMand, CusServiceMand, IsAvtManage, IsCusService,EnableForecastSales, EnableQuotation, EnableSuggestedOrd,IsPriceChange , CusLocation,RecentSales,RecentOrder,MinOrderValue,ARRemarks,GRSettings,BrSettings};
            ...
            else
            {
                ...
                string[] arr = { RouteID.ToString(), cus,cusType,TCL , CDays,PT,noOfInv,IsVAT, IsHold,selectiontype,radius,oncall,IsSO,IsInvoicing,IsI_Sales, IsI_GR, IsI_BR, IsI_FG,
                    ...
                    EnableQuotation, EnableSuggestedOrd,IsPriceChange, CusLocation,RecentSales,RecentOrder,MinOrderValue,ARRemarks,GRSettings,BrSettings};

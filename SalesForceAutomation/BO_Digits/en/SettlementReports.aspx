                            ...
                            <div class="kt-portlet__head-actions col-lg-12 row">
                                <div class="col-lg-12 row" style="font-size: 15px; margin-bottom: 20px;">
                                    ...
                                    <div class="col-lg-3 " style="padding-left: 25px;">
                                     ...
                                     <asp:Label ID="lblsettlementInfo" runat="server" Style="font-weight: 600; padding-top: 5px;" ForeColor="Blue"></asp:Label>
                                                                                ...
                                                                                <tr>
                                                                                  ...
                                                                                  <tr>
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                        ...
                                                                                        <asp:Button ID="btnpettycash" runat="server" Text="Petty Cash" OnClick="btnpettycash_Click" CssClass="btn btn-sm btn-primary" Style="padding: 10px 10px; font-size: 11px; border-radius: 5px;" />
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                        ...
                                                                                        <asp:Button ID="Button1" runat="server" Text="Previous Variances" OnClick="btnPreviousVariances_Click" CssClass="btn btn-sm btn-primary" Style="padding: 10px 10px; font-size: 11px; border-radius: 5px;" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel11" runat="server" LoadingPanelID="RadAjaxLoadingPanel10">
                        <asp:LinkButton ID="btnsttl" runat="server" Text="Yes" OnClick="btnSave_Click" CssClass="btn btn-brand btn-elevate btn-icon-sm" />
                        ...
                        <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-12 pt-3">
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ShowFooter="false" DataKeyNames="sda_ID"
                                        EnableHeaderContextMenu="true">
                                        <Columns>
                            ...
                            <div class="col-lg-12 ">
                                 <telerik:RadNumericTextBox  ID="txtamount" runat="server" CssClass="form-control" NumberFormat-AllowRounding="false" Width="70%" RenderMode="Lightweight" Skin="Silk"></telerik:RadNumericTextBox>
                                             ...
                                             <div class="col-lg-2 mt-2">
                                               <asp:LinkButton  ID="lnkSave" runat="server" CssClass="btn btn-sm fw-bold btn-primary align-content-end"  ValidationGroup="form" CausesValidation="true" OnClick="lnkSave_Click">
                                                  Add
                        </asp:LinkButton>
                        </div>

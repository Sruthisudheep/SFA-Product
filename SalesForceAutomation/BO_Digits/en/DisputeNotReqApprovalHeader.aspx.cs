        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Session["DRFromDate"] != null)
                    {

                        rdfromDate.SelectedDate = DateTime.Parse(Session["DRFromDate"].ToString());
                    }
                    else
                    {
                    ...
                    if (Session["DRToDate"] != null)
                    {

                        rdendDate.SelectedDate = DateTime.Parse(Session["DRToDate"].ToString());
                    }
                    else
                    {
        ...
        protected void lnkFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["DRFromDate"] != null)
                {
                    ...
                    if (fromdate == Session["DRFromDate"].ToString())
                    {
                        rdfromDate.SelectedDate = DateTime.Parse(Session["DRFromDate"].ToString());
                    }
                    else
                    {
                        Session["DRFromDate"] = DateTime.Parse(rdfromDate.SelectedDate.ToString());
                    }
                }
                else
                {
                ...
                if (Session["DRToDate"] != null)
                {
                    ...
                    if (todate == Session["DRToDate"].ToString())
                    {
                        rdendDate.SelectedDate = DateTime.Parse(Session["DRToDate"].ToString());
                    }
                    else
                    {
                        Session["DRToDate"] = DateTime.Parse(rdendDate.SelectedDate.ToString());
                    }

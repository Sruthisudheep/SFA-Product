...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class AddEditProducts : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else                                                                      
                {
                    ...
                    if (lstDatas.Rows.Count > 0)
                    {
                        ...
                        string pname, pcode, pcat, psubcat, pbrd, rtndays, itemlong, arabicName, arabicItemlong, Status, itmSalHold,itmRtnHold,itmOrdHold, prdType, prdChargable,rtnreqhold;                                          //Declare the variables
        ...
        {
            string pname, arabicName, pcode, pcat, psubcat, pbrd, rtndays, itemlong, Status, user, uom, stdprice, UPC, Default, arabicItemlong,itmSalHold, itmRtnHold, itmOrdHold, prdType, prdChargable,rtnreqhold;
			...
			if (ResponseID.Equals("0") || ResponseID == 0)
            {
                ...
                else
                {
                    ...
                    string[] arr = { pcode, pcat, psubcat, pbrd, rtndays, user, itemlong, Status, arabicName, arabicItemlong,itmSalHold,itmRtnHold,itmOrdHold , prdType , prdChargable,rtnreqhold };
            ...
            else
            {
...

                {
                    ...
                    string ID = ResponseID.ToString();
                    string[] arr = { pcode, pcat, psubcat, pbrd, rtndays, user, itemlong, Status, arabicName, arabicItemlong, ID,itmSalHold,itmRtnHold,itmOrdHold, prdType , prdChargable, rtnreqhold };

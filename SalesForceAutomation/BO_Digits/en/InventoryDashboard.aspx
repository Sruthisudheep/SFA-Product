...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-lg-12 row">
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <telerik:RadDatePicker RenderMode="Lightweight" Width="100%" ID="rdfromDate" runat="server"  DateInput-DateFormat="dd-MM-yyyy" >
        ...
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <telerik:RadDatePicker RenderMode="Lightweight" Width="100%" ID="rdendDate" DateInput-DateFormat="dd-MM-yyyy" runat="server" >
                </telerik:RadDatePicker>

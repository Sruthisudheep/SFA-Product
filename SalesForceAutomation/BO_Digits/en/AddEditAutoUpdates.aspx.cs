...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class AddEditAutoUpdates : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            {
                string name, url, code, releasenote,Route,Type;
        ...
        protected void Save()
        {
            try
            {
                ...
                string name, code, url, releasenote, Route, Platform;
                ...
                else
                {
                    if (ddlroute.SelectedValue.ToString().Equals("A"))
                    {
                        string[] array = { name.ToString(), url.ToString(), releasenote.ToString(), Route, type, ResponseID.ToString() };
                    ...
                    else
                    {
                        ...
                        //detail = GetItemFromGrid();
                        string rottype = ddlSprotType.SelectedValue.ToString();
                        string[] ar = { name.ToString(), url.ToString(), releasenote.ToString(), user, ResponseID.ToString() };

        ...
        <telerik:radajaxpanel id="RadAjaxPanel1" runat="server" loadingpanelid="RadAjaxLoadingPanel2">
            ...
            <div class="col-lg-12 row" style="display: -webkit-box; padding-bottom: 10px;">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <telerik:raddatepicker rendermode="Lightweight" id="rdFromDate" dateinput-dateformat="dd-MMM-yyyy" runat="server" width="100%" OnSelectedDateChanged="rdFromDate_SelectedDateChanged">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <telerik:raddatepicker rendermode="Lightweight" id="rdEndDate" dateinput-dateformat="dd-MMM-yyyy" runat="server" width="100%" OnSelectedDateChanged="rdEndDate_SelectedDateChanged">
                        </telerik:raddatepicker>

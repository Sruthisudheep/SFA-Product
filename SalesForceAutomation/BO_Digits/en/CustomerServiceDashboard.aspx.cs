...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class CustomerServiceDashboard : System.Web.UI.Page
    {
        ...
        {
            string rot = Rotids();
            Session["CRArotID"] = rot;
            Session["CRAFromDate"] = rdfromDate.SelectedDate.ToString(); ;
            Session["CRAToDate"] = rdendDate.SelectedDate.ToString(); ;
        ...
        protected void lnkDisputeReqNote_Click(object sender, EventArgs e)
        {
            ...
            Session["Route"] = rot;
            Session["DRrotid"] = rot;
            Session["DRFDate"] = rdfromDate.SelectedDate.ToString(); 
            Session["DRTDate"] = rdendDate.SelectedDate.ToString(); 

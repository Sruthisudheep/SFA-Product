                    ...
                    <div>
                        ...
                        <div class="col-lg-12 row" style="padding-top: 10px;">
                            ...
                            <div class="col-lg-3 ms-8">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDatePicker RenderMode="Lightweight" ID="ddlFromdate" Width="90%" runat="server" DateInput-DateFormat="dd-MM-yyyy" >
                                    </telerik:RadDatePicker>
                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ErrorMessage="From Date is mandatory" ForeColor="Red" ControlToValidate="rdfromDate"></asp:RequiredFieldValidator>
                                    --%>
                                </div>
                               ...
                               <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDatePicker RenderMode="Lightweight" ID="ddlTodate" Width="90%" DateInput-DateFormat="dd-MM-yyyy" runat="server">
                                    </telerik:RadDatePicker>

                                ...
                                <telerik:RadPanelItem Font-Bold="true" Text="Note:" Expanded="false" ForeColor="Blue" BackColor="white">
                                    <ContentTemplate>
										...
										<div class="fs-6 text-gray-700 pe-7">3. If there was a customer item mapping in the 'From Route', a new entry will be created in the 'Customer Item Mapping' with the same values as before, 
                                                    ...
                                                    <div class="fs-6 text-gray-700 pe-7">4. The promotions currently assigned to the selected customers in the 'From Route' will be re-assigned to the 'To Route'.
										</div>
                                                       <div class="fs-6 text-gray-700 pe-7">5.The Special Price assignments for the selected customers in the 'From Route' will be moved to the 'To Route'..
										</div>
                                                </td>
                                            </table>
                                        </div>

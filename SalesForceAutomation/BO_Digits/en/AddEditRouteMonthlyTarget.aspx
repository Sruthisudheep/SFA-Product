                        ...
                        <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                                ...
                                <div class=" col-lg-12 row" style="display: -webkit-box; padding-bottom: 20px">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox ID="ddlrot" runat="server" EmptyMessage="Select Route" CausesValidation="true" RenderMode="Lightweight" Width="100%" Filter="Contains"></telerik:RadComboBox>

...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class AddProducts : System.Web.UI.Page
    {
        ...
        {
            string pname, arabicName, pcode, pcat, psubcat, pbrd, rtndays, itemlong, Status, SalesHold, user, arabicItemlong, RtnHold, OrdHold, prdType, prdChargable,rtnreqhold;
            ...
            else
            {
                ...
                string[] arr = { pcode, pcat, psubcat, pbrd, rtndays, user, itemlong, Status, arabicName, arabicItemlong, SalesHold, RtnHold, OrdHold, detail, prdType, prdChargable,rtnreqhold };
        ...
        {
            string pname, arabicName, pcode, pcat, psubcat, pbrd, rtndays, itemlong, Status, user, itmsaleshold, itmRtnHold, itmOrdHold, arabicItemlong, prdType, prdChargable,rtnreqhold;
            pname = txtPName.Text.ToString();
            arabicName = txtArabic.Text.ToString();
            pcode = txtCode.Text.ToString();
            pcat = ddlcatid.SelectedValue.ToString();

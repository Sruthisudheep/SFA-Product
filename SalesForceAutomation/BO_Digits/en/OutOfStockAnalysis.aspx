...
<%--                            <div class="kt-portlet__head" style="padding-bottom: 10px;">--%>
                                ...
                                <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                    ...
                                    <div class="col-lg-2 ">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:raddatepicker rendermode="Lightweight" id="rdfromDate" dateinput-dateformat="dd-MMM-yyyy" runat="server" OnSelectedDateChanged="rdfromDate_SelectedDateChanged">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:raddatepicker rendermode="Lightweight" id="rdendDate" dateinput-dateformat="dd-MMM-yyyy" runat="server" OnSelectedDateChanged="rdendDate_SelectedDateChanged">
                                            </telerik:raddatepicker>
                    ...
                    <div class=" col-lg-12 row" style="padding-bottom: 10px">
                          <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox ID="ddlAccessPoint" runat="server" Filter="Contains" RenderMode="Lightweight" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" EmptyMessage="Select Access Point" Width="100%">
                                            </telerik:RadComboBox>
                                        </div>
                                    </div>

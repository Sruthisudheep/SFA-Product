                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlcus" runat="server" Width="100%" EmptyMessage="Select Customer" Filter="Contains" OnTextChanged="ddlcus_TextChanged" AllowCustomText="true" CausesValidation="false"></telerik:RadComboBox>
            ...
            <div class="modal-content" style="width:650px;">
                ...
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel4">
                        ...
                        <asp:LinkButton ID="Proceedmap" runat="server" Text="Proceed with Item Mapping" OnClick="Proceedmap_Click" CssClass="btn btn-sm fw-bold btn-primary" CausesValidation="false" />                         
                        <asp:LinkButton ID="btnOK" runat="server" OnClick="btnOK_Click" CssClass="btn btn-sm fw-bold btn-secondary">Proceed without Item Mapping</asp:LinkButton>

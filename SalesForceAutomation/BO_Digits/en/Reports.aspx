                ...
                <div class="kt-portlet__head-label row" style="padding-bottom: 20px;">
                    ...
                    <div class="col-lg-12 row" style="padding-bottom: 10px">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <telerik:RadComboBox RenderMode="Lightweight" ID="ddlRoute" runat="server" EmptyMessage="Select Route" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true">
                                </telerik:RadComboBox>
